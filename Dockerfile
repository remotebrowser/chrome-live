...
COPY browser-trace/main.py browser-trace/recording.py browser-trace/server.py browser-trace/traffic.py browser-trace/upload.py browser-trace/config_file.py browser-trace/captcha_classifier.js browser-trace/browser-trace.spec ./
